...
const AuroraDecor = () => (
  <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden" aria-hidden>
    ...
    />
    <div
      className="absolute right-[-120px] top-[15%] h-[520px] w-[520px] rounded-full opacity-25 blur-[120px]"
      style={{ background: 'radial-gradient(circle, rgba(236,72,153,0.7) 0%, transparent 68%)' }}
    />
    <div
      className="absolute bottom-[-140px] left-[20%] h-[460px] w-[460px] rounded-full opacity-20 blur-[100px]"
...
const DotsDecor = () => (
  <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden" aria-hidden>
    <div
      ...
      style={{
        background: 'linear-gradient(145deg, rgba(2,6,23,0.95), rgba(15,23,42,0.95))',
      }}
    />
...
const WavesDecor = () => (
  <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden" aria-hidden>
    ...
    />
    <svg className="absolute inset-0 h-full w-full opacity-[0.2]" viewBox="0 0 1440 900" preserveAspectRatio="none">
