export const caseItemsContent = [
  {
    ...
    summary:
      'LED-порталы и задник сцены, звуковая система под 800 гостей, свет для спикеров и трансляции.',
  ...
  },
  {
    ...
    summary:
      'Большая сцена с порталами, линейные массивы, вогнутый LED-задник, световое шоу.',
  ...
  },
  {
    ...
    summary:
      'LED-тотемы и центральный экран, плейаут контента, быстрая сборка ночью.',
